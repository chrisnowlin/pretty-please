...
## Overview
React component for configuring embedding generation parameters via preset selection and advanced controls.
...
- Component: `frontend/src/components/settings/EmbeddingConfigPanel.tsx`
- Uses React Query for state management
- Follows patterns from `RAGConfigPanel`
