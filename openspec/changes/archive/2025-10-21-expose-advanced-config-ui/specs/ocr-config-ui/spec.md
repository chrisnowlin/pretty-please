...
## Overview
React component for configuring OCR processing parameters via preset selection and advanced controls.
...
- Component: `frontend/src/components/settings/OCRConfigPanel.tsx`
- Uses React Query for state management
- Follows patterns from `CollectionConfigPanel`
